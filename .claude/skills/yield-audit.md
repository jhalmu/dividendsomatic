...
- When yield values look suspicious (e.g., >40% for blue chips)
...
- TRIN: 10-17% normal, >25% suspicious
...
Three tests in `test/dividendsomatic/portfolio_test.exs` under `describe "yield FX consistency"`:
...
- `lib/dividendsomatic/portfolio.ex` — `symbol_current_yield/3`, `symbol_yield_on_cost/3`, `symbol_projected_annual/3`
- `lib/dividendsomatic/portfolio/dividend_analytics.ex` — `compute_annual_dividend_per_share/2`
- `test/dividendsomatic/portfolio_test.exs` — yield FX regression tests
